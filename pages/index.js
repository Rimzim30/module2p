...
import atm_abi from "../artifacts/contracts/Assessment.sol/Module2.json"
...
export default function HomePage() {
  ...
  const contractAddress = "0x5Cf1271dB03F3735BBCb5bE114A285c22F8f91e5";
  ...
  return (
    <main className="container">
      ...
      <div className="content">
        {!account ? (
          <button onClick={connectAccount}>MetaMask</button>
        ) : (
          <>
